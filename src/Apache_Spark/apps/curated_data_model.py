...
fact_article_keyword_fields = [
    ...
    {"name": "ArticleID_NK", "type": "STRING", "comment": "Thành phần của khóa tổ hợp định danh bản ghi. Đồng thời là Khóa ngoại (FK) đến ArticleID_NK của bài viết trong bảng fact_article_publication hoặc articles (clean)."},
...
fact_top_comment_activity_table_comment = "Bảng sự kiện ghi nhận các số liệu chính liên quan đến các bình luận 'top' được crawl."
...
fact_top_comment_interaction_detail_table_comment = "Bảng sự kiện ghi nhận chi tiết từng loại tương tác (Thích, Vui,...) trên các bình luận 'top'."
